package com.selenium.test.testng.tests.listeners;

import com.selenium.test.configuration.Configuration;
 ...
 */
public class ScreenShotOnFailListener extends TestListenerAdapter {
